<template>
  <div class="collection">
    <van-nav-bar left-arrow @click-left="$router.back()" title="收藏列表" placeholder fixed z-index="999" />
    <div v-if="small">
    ...
    <div v-else>
      ...
      <van-pull-refresh v-else v-model="refreshing" @refresh="onRefresh" style="min-height: 100vh;">
