<template>
  <div class="forget">
    <van-nav-bar title="忘记密码" left-arrow @click-left="$router.back()" placeholder fixed z-index="999" />
    ...
    <div class="ipt" style="margin-top:20px;">
      ...
      <input type="password" placeholder="请输入新的密码" autocomplete="off" v-model="password">
